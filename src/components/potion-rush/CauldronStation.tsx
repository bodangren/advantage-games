...
function SingleCauldron({ cauldron, x, y, onDrop, images }: { 
    cauldron: Cauldron, 
    x: number, 
    y: number, 
    ...
    return (
        ...
        >
            ...
            {cauldron.state === 'COMPLETED' && (
                <Text text="DONE!" fontSize={24} fontStyle="bold" fill="#facc15" x={-35} y={-40} stroke="black" strokeWidth={1} />
            )}
             {cauldron.state === 'WARNING' && (
                <Text text="RUINED!" fontSize={18} fontStyle="bold" fill="#ef4444" x={-40} y={40} stroke="black" strokeWidth={1} />
            )}
        </Group>
    )
}
