...
type DragonRiderGameProps = {
  vocabulary: VocabularyItem[]
  durationMs?: number
  onComplete?: (results: DragonRiderResults) => void
  preloadedAssets?: DragonRiderAssets
}
...
const ASSETS = {
  ...
  playerCamera: withBasePath('/games/dragon-rider/player-3x3-sheet-facing-camera.png'),
  ...
  parallaxMiddle: withBasePath('/games/dragon-rider/parallax-middle-tiling.png'),
  parallaxBottom: withBasePath('/games/dragon-rider/parallax-bottom-tiling.png'),
  loadingBackground: withBasePath('/games/dragon-rider/loading-screen-background.png'),
}
...
export function DragonRiderGame({
  ...
  const [assets, setAssets] = useState<DragonRiderAssets | null>(preloadedAssets ?? null)
  const [isLoading, setIsLoading] = useState(!preloadedAssets)
  const [state, setState] = useState<DragonRiderState>(() => {
    return createDragonRiderState(vocabulary, { durationMs })
  })
  ...
  const resetGame = useCallback(() => {
    const nextState = createDragonRiderState(vocabulary, { durationMs })
