...
Audit the **Astral Mage** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Title** | Astral Mage |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/astral-mage/AstralMageGame.tsx` |
| **Logic** | `src/lib/games/astralMage.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/astral-mage/page.tsx` |
| **API** | `src/app/api/v1/games/astral-mage/sentence/route.ts` |
| **Assets** | `public/games/sentence/astral-mage/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/astral-mage/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/astral-mage-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/astral-mage-compliance-audit_20260426/report.md`.
