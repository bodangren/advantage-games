...
Audit the **Babel Architect** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Type** | sentence |
| **Component** | `src/components/games/sentence/babel-architect/BabelArchitectGame.tsx` |
| **Logic** | `src/lib/games/babelArchitect.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/babel-architect/page.tsx` |
| **API** | `src/app/api/v1/games/babel-architect/sentence/route.ts` |
| **Assets** | `public/games/sentence/babel-architect/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/babel-architect/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/babel-architect-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/babel-architect-compliance-audit_20260426/report.md`.
