...
### Summary
- Audited archers-revenge against 25 shared game specifications
- Result: 25/25 passing after fixes (23 passing at start, 2 failures)
- Fixes: hook deps (gameState ref pattern), unused vars (locale/session)
- Final coverage: 93.14% overall (logic 99.16%, component 88.72%)
...
- Fixes: useGameFullscreen, useAccessibilitySettings, text sizes, SentenceItem typing, API route factories, i18n/session, difficulty tiers, hook deps, component tests, assets
- Final coverage: 88.81% overall
