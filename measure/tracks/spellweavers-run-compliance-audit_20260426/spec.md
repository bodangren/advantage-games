...
Audit the **Spellweaver's Run** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `spellweavers-run` |
| **Title** | Spellweaver's Run |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/spellweavers-run/SpellweaversRunGame.tsx` |
| **Logic** | `src/lib/games/spellweaversRun.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/spellweavers-run/page.tsx` |
| **API** | `src/app/api/v1/games/spellweavers-run/sentences/route.ts` |
| **Assets** | `public/games/sentence/spellweavers-run/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/spellweavers-run/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/cover-spellweavers-run.png`.
...
- [ ] Final compliance report written to `measure/tracks/spellweavers-run-compliance-audit_20260426/report.md`.
