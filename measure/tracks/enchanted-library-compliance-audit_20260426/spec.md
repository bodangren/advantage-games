...
Audit the **Enchanted Library** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `enchanted-library` |
| **Title** | Enchanted Library |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/enchanted-library/EnchantedLibraryGame.tsx` |
| **Logic** | `src/lib/games/enchantedLibrary.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/enchanted-library/page.tsx` |
| **API** | `src/app/api/v1/games/enchanted-library/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/enchanted-library/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/enchanted-library/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/enchanted-library-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/enchanted-library-compliance-audit_20260426/report.md`.
