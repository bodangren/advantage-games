...
Audit the **Storm the Castle Tower** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Type** | sentence |
| **Component** | `src/components/games/sentence/storm-castle-tower/StormCastleTowerGame.tsx` |
| **Logic** | `src/lib/games/stormCastleTower.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/storm-castle-tower/page.tsx` |
| **API** | `src/app/api/v1/games/storm-castle-tower/sentences/route.ts` |
| **Assets** | `public/games/sentence/storm-castle-tower/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/storm-castle-tower/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/storm-castle-tower-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/storm-castle-tower-compliance-audit_20260426/report.md`.
