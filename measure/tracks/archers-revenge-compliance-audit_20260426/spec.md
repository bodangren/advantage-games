...
Audit the **Archer's Revenge** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `archers-revenge` |
| **Title** | Archer's Revenge |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/archers-revenge/ArchersRevengeGame.tsx` |
| **Logic** | `src/lib/games/archersRevenge.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/archers-revenge/page.tsx` |
| **API** | `src/app/api/v1/games/archers-revenge/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/archers-revenge/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/archers-revenge/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/archers-revenge-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/archers-revenge-compliance-audit_20260426/report.md`.
