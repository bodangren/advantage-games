...
Audit the **Rune Match** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Title** | Rune Match |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/rune-match/RuneMatchGame.tsx` |
| **Logic** | `src/lib/games/runeMatch.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/rune-match/page.tsx` |
| **API** | `src/app/api/v1/games/rune-match/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/rune-match/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/rune-match/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/rune-match-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/rune-match-compliance-audit_20260426/report.md`.
