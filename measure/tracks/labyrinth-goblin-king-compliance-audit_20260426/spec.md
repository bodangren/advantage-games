...
Audit the **Labyrinth of the Goblin King** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `labyrinth-goblin-king` |
| **Title** | Labyrinth of the Goblin King |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/labyrinth-goblin-king/LabyrinthGoblinKingGame.tsx` |
| **Logic** | `src/lib/games/labyrinthGoblinKing.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/labyrinth-goblin-king/page.tsx` |
| **API** | `src/app/api/v1/games/labyrinth-goblin-king/sentences/route.ts` |
| **Assets** | `public/games/sentence/labyrinth-goblin-king/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/labyrinth-goblin-king/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/labyrinth-goblin-king-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/labyrinth-goblin-king-compliance-audit_20260426/report.md`.
