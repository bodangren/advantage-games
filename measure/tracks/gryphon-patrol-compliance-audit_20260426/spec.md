...
Audit the **Gryphon Patrol** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `gryphon-patrol` |
| **Title** | Gryphon Patrol |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/gryphon-patrol/GryphonPatrolGame.tsx` |
| **Logic** | `src/lib/games/gryphonPatrol.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/gryphon-patrol/page.tsx` |
| **API** | `src/app/api/v1/games/gryphon-patrol/sentence/route.ts` |
| **Assets** | `public/games/sentence/gryphon-patrol/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/gryphon-patrol/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/gryphon-patrol-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/gryphon-patrol-compliance-audit_20260426/report.md`.
