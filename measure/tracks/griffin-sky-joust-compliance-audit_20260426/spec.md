...
Audit the **Griffin Sky-Joust** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `griffin-sky-joust` |
| **Title** | Griffin Sky-Joust |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/griffin-sky-joust/GriffinSkyJoustGame.tsx` |
| **Logic** | `src/lib/games/griffinSkyJoust.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/griffin-sky-joust/page.tsx` |
| **API** | `src/app/api/v1/games/griffin-sky-joust/sentences/route.ts` |
| **Assets** | `public/games/sentence/griffin-sky-joust/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/griffin-sky-joust/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/griffin-sky-joust-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/griffin-sky-joust-compliance-audit_20260426/report.md`.
