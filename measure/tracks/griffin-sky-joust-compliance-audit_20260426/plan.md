...
- [ ] Task: Verify React-Konva usage in GriffinSkyJoustGame.tsx.
- [ ] Task: Verify mobile-first portrait (390×844) responsive scaling.
- [ ] Task: Verify pure state + tick function pattern in griffinSkyJoust.ts.
...
- [ ] Task: Commit all changes with `chore(audit): Griffin Sky-Joust compliance audit complete`.
