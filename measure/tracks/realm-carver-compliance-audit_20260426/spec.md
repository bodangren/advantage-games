...
Audit the **Realm Carver** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `realm-carver` |
| **Title** | Realm Carver |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/realm-carver/RealmCarverGame.tsx` |
| **Logic** | `src/lib/games/realmCarver.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/realm-carver/page.tsx` |
| **API** | `src/app/api/v1/games/realm-carver/sentences/route.ts` |
| **Assets** | `public/games/sentence/realm-carver/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/realm-carver/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/realm-carver-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/realm-carver-compliance-audit_20260426/report.md`.
