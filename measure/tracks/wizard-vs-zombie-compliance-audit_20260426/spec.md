...
Audit the **Wizard vs Zombie** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `wizard-vs-zombie` |
| **Title** | Wizard vs Zombie |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/wizard-vs-zombie/WizardZombieGame.tsx` |
| **Logic** | `src/lib/games/wizardZombie.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/wizard-vs-zombie/page.tsx` |
| **API** | `src/app/api/v1/games/wizard-vs-zombie/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/wizard-vs-zombie/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/wizard-vs-zombie/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/wizard-vs-zombie-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/wizard-vs-zombie-compliance-audit_20260426/report.md`.
