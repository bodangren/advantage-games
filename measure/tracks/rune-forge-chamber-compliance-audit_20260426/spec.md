...
Audit the **Rune Forge Chamber** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Type** | sentence |
| **Component** | `src/components/games/sentence/rune-forge-chamber/RuneForgeChamberGame.tsx` |
| **Logic** | `src/lib/games/runeForgeChamber.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/rune-forge-chamber/page.tsx` |
| **API** | `src/app/api/v1/games/rune-forge-chamber/sentences/route.ts` |
| **Assets** | `public/games/sentence/rune-forge-chamber/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/rune-forge-chamber/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/cover-rune-forge-chamber.png`.
...
- [ ] Final compliance report written to `measure/tracks/rune-forge-chamber-compliance-audit_20260426/report.md`.
