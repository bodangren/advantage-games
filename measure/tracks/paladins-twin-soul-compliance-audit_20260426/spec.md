...
Audit the **Paladin's Twin-Soul** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `paladins-twin-soul` |
| **Title** | Paladin's Twin-Soul |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/paladins-twin-soul/PaladinsTwinSoulGame.tsx` |
| **Logic** | `src/lib/games/paladinsTwinSoul.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/paladins-twin-soul/page.tsx` |
| **API** | `src/app/api/v1/games/paladins-twin-soul/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/paladins-twin-soul/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/paladins-twin-soul/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/paladins-twin-soul-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/paladins-twin-soul-compliance-audit_20260426/report.md`.
