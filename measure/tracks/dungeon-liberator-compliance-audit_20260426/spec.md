...
Audit the **Dungeon Liberator** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `dungeon-liberator` |
| **Title** | Dungeon Liberator |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/dungeon-liberator/DungeonLiberatorGame.tsx` |
| **Logic** | `src/lib/games/dungeonLiberator.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/dungeon-liberator/page.tsx` |
| **API** | `src/app/api/v1/games/dungeon-liberator/sentences/route.ts` |
| **Assets** | `public/games/sentence/dungeon-liberator/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/dungeon-liberator/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/dungeon-liberator.png`.
...
- [ ] Final compliance report written to `measure/tracks/dungeon-liberator-compliance-audit_20260426/report.md`.
