...
Audit the **Griffin Riders Escape** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Type** | sentence |
| **Component** | `src/components/games/sentence/griffin-riders-escape/GriffinRidersEscapeGame.tsx` |
| **Logic** | `src/lib/games/griffinRidersEscape.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/griffin-riders-escape/page.tsx` |
| **API** | `src/app/api/v1/games/griffin-riders-escape/sentence/route.ts` |
| **Assets** | `public/games/sentence/griffin-riders-escape/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/griffin-riders-escape/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/griffin-riders-escape-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/griffin-riders-escape-compliance-audit_20260426/report.md`.
