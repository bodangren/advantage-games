...
Audit the **Castle Defense** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `castle-defense` |
| **Title** | Castle Defense |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/castle-defense/CastleDefenseGame.tsx` |
| **Logic** | `src/lib/games/castleDefense.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/castle-defense/page.tsx` |
| **API** | `src/app/api/v1/games/castle-defense/sentence/route.ts` |
| **Assets** | `public/games/sentence/castle-defense/` |
...
- [ ] **Sentence Data** — Uses `SentenceItem[]` with `{ text, words }`.
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/castle-defense/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/castle-defense-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/castle-defense-compliance-audit_20260426/report.md`.
