...
Audit the **Devourer Slime** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `devourer-slime` |
| **Title** | Devourer Slime |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/devourer-slime/DevourerSlimeGame.tsx` |
| **Logic** | `src/lib/games/devourerSlime.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/devourer-slime/page.tsx` |
| **API** | `src/app/api/v1/games/devourer-slime/sentence/route.ts` |
| **Assets** | `public/games/sentence/devourer-slime/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/devourer-slime/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/devourer-slime-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/devourer-slime-compliance-audit_20260426/report.md`.
