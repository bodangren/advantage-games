...
Audit the **Dragon Rider** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `dragon-rider` |
| **Title** | Dragon Rider |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/dragon-rider/DragonRiderGame.tsx` |
| **Logic** | `src/lib/games/dragonRider.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/dragon-rider/page.tsx` |
| **API** | `src/app/api/v1/games/dragon-rider/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/dragon-rider/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/dragon-rider/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/dragon-rider-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/dragon-rider-compliance-audit_20260426/report.md`.
