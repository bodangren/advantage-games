...
Audit the **RPG Battle** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.
...
| **Title** | RPG Battle |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/rpg-battle/BattleScene.tsx` |
| **Logic** | `src/lib/games/rpgBattleWordSelection.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/rpg-battle/page.tsx` |
| **API** | `src/app/api/v1/games/rpg-battle/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/rpg-battle/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/rpg-battle/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/rpg-battle-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/rpg-battle-compliance-audit_20260426/report.md`.
