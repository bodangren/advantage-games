...
Audit the **Magic Defense** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `magic-defense` |
| **Title** | Magic Defense |
| **Type** | vocabulary |
| **Component** | `src/app/[locale]/(student)/student/games/vocabulary/magic-defense/page.tsx` |
| **Logic** | `src/lib/games/magicDefenseConfig.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/magic-defense/page.tsx` |
| **API** | `src/app/api/v1/games/magic-defense/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/magic-defense/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/magic-defense/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/magic-defense-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/magic-defense-compliance-audit_20260426/report.md`.
