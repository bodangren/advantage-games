...
Audit the **Shadow Gate Dungeon** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `shadow-gate-dungeon` |
| **Title** | Shadow Gate Dungeon |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/shadow-gate-dungeon/ShadowGateDungeonGame.tsx` |
| **Logic** | `src/lib/games/shadowGateDungeon.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/shadow-gate-dungeon/page.tsx` |
| **API** | `src/app/api/v1/games/shadow-gate-dungeon/sentences/route.ts` |
| **Assets** | `public/games/sentence/shadow-gate-dungeon/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/shadow-gate-dungeon/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/cover-shadow-gate-dungeon.png`.
...
- [ ] Final compliance report written to `measure/tracks/shadow-gate-dungeon-compliance-audit_20260426/report.md`.
