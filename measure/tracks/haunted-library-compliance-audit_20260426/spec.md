...
Audit the **Haunted Library** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `haunted-library` |
| **Title** | Haunted Library |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/haunted-library/HauntedLibraryGame.tsx` |
| **Logic** | `src/lib/games/hauntedLibrary.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/haunted-library/page.tsx` |
| **API** | `src/app/api/v1/games/haunted-library/sentence/route.ts` |
| **Assets** | `public/games/sentence/haunted-library/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/haunted-library/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/haunted-library-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/haunted-library-compliance-audit_20260426/report.md`.
