...
Audit the **Village Guardian** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `village-guardian` |
| **Title** | Village Guardian |
| **Type** | sentence |
| **Component** | `src/components/games/sentence/village-guardian/VillageGuardianGame.tsx` |
| **Logic** | `src/lib/games/villageGuardian.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/sentence/village-guardian/page.tsx` |
| **API** | `src/app/api/v1/games/village-guardian/sentences/route.ts` |
| **Assets** | `public/games/sentence/village-guardian/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/sentence/village-guardian/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/cover-village-guardian.png`.
...
- [ ] Final compliance report written to `measure/tracks/village-guardian-compliance-audit_20260426/report.md`.
