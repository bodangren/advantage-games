...
Audit the **Dragon Flight** game against the 25 shared specifications that have been standardized across all vocabulary/sentence games in the advantage-games platform (March–April 2026). This track produces a pass/fail compliance report and fixes any non-compliant items.

## Game Under Audit

| Property | Value |
|----------|-------|
| **Game ID** | `dragon-flight` |
| **Title** | Dragon Flight |
| **Type** | vocabulary |
| **Component** | `src/components/games/vocabulary/dragon-flight/DragonFlightGame.tsx` |
| **Logic** | `src/lib/games/dragonFlight.ts` |
| **Page** | `src/app/[locale]/(student)/student/games/vocabulary/dragon-flight/page.tsx` |
| **API** | `src/app/api/v1/games/dragon-flight/vocabulary/route.ts` |
| **Assets** | `public/games/vocabulary/dragon-flight/` |
...
- [ ] **Asset Location** — PNGs/sprite sheets in `/public/games/vocabulary/dragon-flight/`.
- [ ] **Cover Image** — Cover image at `/public/games/cover/dragon-flight-cover.png`.
...
- [ ] Final compliance report written to `measure/tracks/dragon-flight-compliance-audit_20260426/report.md`.
