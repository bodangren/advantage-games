...
## Phase 1: Housekeeping & Deployment Prep
- [~] Task: Configure Next.js for static export and add a GitHub Actions workflow to build a static site artifact.
- [ ] Task: Add cover-based cards for all upcoming games to the main menu/choice screen using `public/games/cover/`.
- [ ] Task: Update Magic Defense asset references to use `public/games/magic-defense/`.
- [ ] Task: Add unit/component tests for the main menu card data and asset mapping updates.
- [ ] Task: Conductor - User Manual Verification 'Phase 1: Housekeeping & Deployment Prep' (Protocol in workflow.md)
