...
- [ ] Task: Conductor — User Manual Verification 'Phase 1: Fill-in-the-Blank Platformer' (Protocol in workflow.md)
...
- [ ] Task: Register in game catalog and test end-to-end.
  ...
  - [ ] Verify 390×844 viewport rendering.
- [ ] Task: Conductor — User Manual Verification 'Phase 2: Word Reorder / Sequence Builder' (Protocol in workflow.md)
...
- [ ] Task: Register in game catalog and test end-to-end.
  ...
  - [ ] Verify 390×844 viewport rendering.
- [ ] Task: Conductor — User Manual Verification 'Phase 3: Translation Matching Game' (Protocol in workflow.md)
...
- [ ] Task: Register in game catalog and test end-to-end.
  ...
  - [ ] Verify 390×844 viewport rendering.
- [ ] Task: Conductor — User Manual Verification 'Phase 4: Context Clue Detective' (Protocol in workflow.md)
