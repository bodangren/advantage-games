...
### High Priority
- griffinSkyJoust.test.ts line 92: "should handle collision from above with wrong word" expects HP=2 but gets HP=3 — game logic bug in collision detection (pre-existing)
